...
type ListInstitutionsParams struct {
	...
	SeparateContinuousHistoryConsentSupported string `url:"separate_continuous_history_consent_supported,omitempty" json:"separate_continuous_history_consent_supported,omitempty"`
